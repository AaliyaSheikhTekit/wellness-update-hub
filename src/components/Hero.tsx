          ...
          <div className="grid lg:grid-cols-1 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                <motion.p
                  className="text-xl text-dark-foreground leading-relaxed max-w-auto"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  ...
                  <br />
                  The true meaning of the word “Iksha” is "knowledge of the
                  soul" and at Ikshā Naturopathy, we believe in nurturing the
                  natural ability to heal from within and thrive. Our expert
                  naturopaths provide personalized care using time-tested
                  natural therapies such as hydrotherapy, chromotherapy, earthen
                  mud therapy, yoga therapy, acupuncture, acupressure,
                  counseling mind calming therapies.
                </motion.p>
              </div>
              <AnimatePresence>
                {showMore && (
                  ...
                  >
                    <p>
                      Whether you’re seeking relief from chronic conditions,
                      looking to boost your energy, or simply want a more
                      natural, sustainable path to wellness — our integrated
                      system is designed to support you every step of the way.
                    </p>
                    <p>
                      <strong>Feel the strength of Earth</strong>, grounding you
                      in peace.
                      <br />
                      <strong>Flow with Water</strong>, cleansing and refreshing
                      every cell.
                      <br />
                      <strong>Awaken the Fire</strong> within, igniting energy
                      and vitality.
                      <br />
                      <strong>Embrace the Air</strong>, calming your mind and
                      spirit.
                      <br />
                      <strong>Expand into Space</strong>, finding freedom and
                      inner harmony.
                      <br />
                      Finally, let the <strong>Life force</strong> within you
                      guide you to healthy practices.
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
