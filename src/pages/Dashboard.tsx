...
const Dashboard = () => {
  ...
  const sidebarItems = [
    { name: "Patients", icon: Users, path: "/dashboard", active: true },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className={`fixed left-0 top-0 h-full w-64 wellness-card-gradient border-r border-border/50 transform wellness-transition duration-300 z-30 ${
        ...
        <nav className="p-4 space-y-2">
          {sidebarItems.map((item) => (
            <Link
              key={item.name}
              to={item.path}
              className={`flex items-center space-x-3 px-4 py-3 rounded-lg wellness-transition ${
                item.active
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <Link
            to="/login"
            className="flex items-center space-x-3 px-4 py-3 text-muted-foreground hover:text-foreground hover:bg-wellness-sage-light/10 rounded-lg wellness-transition"
          >
      ...
      <div className="lg:ml-64">
        ...
        <header className="wellness-card-gradient border-b border-border/50 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="font-display text-3xl font-bold text-foreground">Patient Management</h1>
            </div>
          </div>
        </header>
        ...
        <main className="p-6">
          ...
          <Card className="wellness-card-gradient border-0 wellness-shadow">
            <CardHeader>
              <CardTitle className="font-display text-2xl text-foreground">Patient List</CardTitle>
            </CardHeader>
            <CardContent>
